<div align="center" >
    ...
    <p>
      <a href="https://github.com/HiMeditator/auto-caption/releases"><img src="https://img.shields.io/badge/release-2.18.0-blue"></a>
    ...
    <p><i>v2.18.0 がリリースされました。macOS arm64 ビルドを含みます...</i></p>
</div>
...
> ⚠️ 注意：現在の v2.18.0 は Windows と macOS arm64 ビルドを提供しています。Linux はソースまたは既存のビルド手順での検証が必要です。
