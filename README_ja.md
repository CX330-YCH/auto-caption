<div align="center" >
    ...
    <p>
      <a href="https://github.com/HiMeditator/auto-caption/releases"><img src="https://img.shields.io/badge/release-2.8.0-blue"></a>
    ...
    <p><i>v2.8.0 がリリースされました。macOS arm64 ビルドを含みます...</i></p>
</div>
...
- INFO/WARN/ERROR のログ画面と非表示の完全 Debug セッションを分離し、起動単位のマスキング済み `.jsonl` 診断ログを保存可能

## 📖 基本使い方

> ⚠️ 注意：現在の v2.8.0 は Windows と macOS arm64 ビルドを提供しています。Linux はソースまたは既存のビルド手順での検証が必要です。
