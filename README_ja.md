<div align="center" >
    ...
    <p><i>v2.0.0 がリリースされました。V2 設定アーキテクチャ、Fun-ASR、macOS arm64 ビルドを提供します...</i></p>
</div>
...
> ⚠️ 注意：現在の v2.0.0 は Windows と macOS arm64 ビルドを提供しています。Linux はソースまたは既存のビルド手順での検証が必要です。
