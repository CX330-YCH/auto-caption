<div align="center" >
    ...
    <p><i>v2.15.0 has been released with a macOS arm64 build...</i></p>
</div>
...
- Keep the existing sentence view or switch to exact line rolling with sentence-boundary or continuous layout
...
> ⚠️ Note: v2.15.0 currently provides Windows and macOS arm64 builds; Linux still needs verification from source or the existing build pipeline.
