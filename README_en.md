<div align="center" >
    ...
    <p><i>v2.16.0 has been released with a macOS arm64 build...</i></p>
</div>
...
> ⚠️ Note: v2.16.0 currently provides Windows and macOS arm64 builds; Linux still needs verification from source or the existing build pipeline.
