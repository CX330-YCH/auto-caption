<div align="center" >
    ...
    <p>
      <a href="https://github.com/HiMeditator/auto-caption/releases"><img src="https://img.shields.io/badge/release-2.3.0-blue"></a>
    ...
    <p><i>v2.3.0 has been released with a packaging path fix and a macOS arm64 build...</i></p>
</div>
...
> ⚠️ Note: v2.3.0 currently provides Windows and macOS arm64 builds; Linux still needs verification from source or the existing build pipeline.
