<div align="center" >
    ...
    <p>
      <a href="https://github.com/HiMeditator/auto-caption/releases"><img src="https://img.shields.io/badge/release-2.14.0-blue"></a>
    ...
    <p><i>v2.14.0 has been released with a macOS arm64 build...</i></p>
</div>
...
- Keep the existing sentence view or switch to line-by-line rolling captions driven by exact wrapping
...
> ⚠️ Note: v2.14.0 currently provides Windows and macOS arm64 builds; Linux still needs verification from source or the existing build pipeline.
