export default {
  ...
  "fun_asr.key.missing": "The Fun-ASR API KEY is not set and DASHSCOPE_API_KEY was not detected. Use an Alibaba Cloud Model Studio API key that matches the selected region and workspace.",
