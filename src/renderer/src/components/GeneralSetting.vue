<template>
  <a-card size="small" :title="$t('general.title')">
    ...
    <SettingsForm>
      <SettingsField :label="$t('general.uiLanguage')" control-layout="equal">
      ...
      <SettingsField :label="$t('general.theme')" control-layout="equal">
      ...
      <SettingsField :label="$t('general.color')" control-layout="equal">
        <a-radio-group v-model:value="uiColor" class="color-radio-group">
          <template v-for="color in colorList" :key="color">
            <a-radio-button :value="color" :style="{ backgroundColor: color }">
      ...
      <SettingsField :label="$t('general.barWidth')">
        <a-slider
          :min="6"
          :max="12"
          v-model:value="leftBarWidth"
...
const colorListDark = ['#1677ff', '#00b96b', '#fa8c16', '#9254de', '#eb2f96', '#b9d7ea']
