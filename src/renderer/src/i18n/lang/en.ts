export default {
  ...
  style: {
    ...
    fontPicker: {
      "useSystemFonts": "Use System Fonts",
      "useManualInput": "Manual Input",
      "manualPlaceholder": "Enter a font name or CSS font stack",
      "refresh": "Refresh Font List",
      "loading": "Reading locally installed fonts…",
      "denied": "Local fonts cannot be accessed. You can continue with manual input.",
      "unsupported": "System font enumeration is unavailable. You can continue with manual input.",
      "failed": "Local fonts could not be read. Retry or continue with manual input.",
      "unavailable": "This font was not found on the current system; a fallback font will be used.",
      "customStack": "The current value is a custom CSS font stack.",
      "customValue": "Custom",
      "invalidTitle": "Invalid Font Setting",
      "invalidValue": "The font must be valid CSS, non-empty, and no longer than 256 characters.",
      "noResults": "No matching fonts",
      "previewText": "Live Caption 字幕 かな"
    },
