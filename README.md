<div align="center" >
    ...
    <p><i>v2.15.0 版本已经发布，包含 macOS arm64 构建...</i></p>
</div>
...
- 支持保留原有整句显示，或切换为基于精确换行的逐行滚动字幕；滚动模式可选择跟随断句换行或连续排版
...
> ⚠️ 注意：当前 v2.15.0 已提供 Windows 和 macOS arm64 构建；Linux 仍需从源码或现有构建链路验证。
